...
# Add parent directory to path to import engine if needed, 
# although we'll keep it simple by assuming it's in the same v2 folder.
from calculator_engine_v2 import CalculatorEngineV2

class RiceCalculatorV2:
    def __init__(self, master):
        self.master = master
        master.title("Rice Calculator V2 (K/Non-K)")
        # Set a fixed size initially to avoid jumping
        master.geometry("720x750")
        
        self.engine = CalculatorEngineV2()
    ...
    def setup_ui(self):
        ...
        # FIXED: Set height and ensure it expands correctly in the grid
    ...
    def setup_precision_switch(self):
        ...
        self.prec_var = tk.IntVar(value=2)
    ...
    def update_settings(self, val=None):
        ...
        # Engine precision is internal, but we could cap it if needed
        self.update_display()
